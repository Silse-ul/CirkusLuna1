...
public class ArtistRepository : IArtistRepository
{
    ...
    public ArtistRepository()
    {
        ...
        Artist g = new Artist(" Bella Belladonna",
            ...
            "Månens Hemmeligheder", "image/bella.png");
        _artistsList.Add(g);
        Artist r = new Artist("Celeste Noire",
            ...
            "Det Erotiske Mørke", "image/celeste.png");
        _artistsList.Add(r);
        Artist b = new Artist("Bruno “The Beast” Moretti",
            ...
            "Titanernes Kamp", "image/the_beast.png"); 
        _artistsList.Add(b);
        ...
        Artist m = new Artist("Thunderhoof",
            ...
            "Den Sidste Galop", "image/thunderhood.png");
        _artistsList.Add(m);
        Artist o = new Artist("The Royal Ruff Pack (Hundegruppe)",
            ...
            "Poter i Perfektion", "image/dogs.png");
        _artistsList.Add(o);
        Artist p = new Artist("The Inferno Riders (Motorcykelstuntgruppe)",
            ...
            "Dødskuglens Raseri", "image/riders.png");
        _artistsList.Add(p);
        Artist w = new Artist("The Great Mordecai (Tryllekunstner & illusionist)",
            ...
            "Mester over Illusionerne", "image/mordecai.png");
        _artistsList.Add(w);
